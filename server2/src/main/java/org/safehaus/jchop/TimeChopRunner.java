...
import org.safehaus.jchop.tracker.TimeChopTracker;
 ...
 */
public class TimeChopRunner extends ChopRunner<TimeChopTracker> {

    public TimeChopRunner( Class<?> testClass ) {
        super( new TimeChopTracker( testClass ) );
    }
