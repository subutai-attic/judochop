...
import org.safehaus.jchop.tracker.IterationChopTracker;
 ...
 */
public class IterationChopRunner extends ChopRunner<IterationChopTracker> {

    public IterationChopRunner( Class<?> testClass ) {
        super( new IterationChopTracker( testClass ) );
    }
