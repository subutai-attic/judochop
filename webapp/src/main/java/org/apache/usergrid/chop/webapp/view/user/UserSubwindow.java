...
public class UserSubwindow extends Window {
    ...
    private void initLayout() {
        ...
        // On the left side, expand the size of the userList so that it uses all the space left after from bottomLeftLayout
    ...
    private void showSelectedUser() {
        ...
        // When a contact is selected from the list, we want to show that in our editor on the right. This is nicely done by the
		// FieldGroup that binds all the fields to the corresponding Properties in our contact at once.
        if (itemId == null) {
            return;
        }
